  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr bgcolor="#E4E4E4">
      <td height="246" valign="top" bgcolor="#E4E4E4">
          <form action="Link_add_sub.php" method="post" name="sample" id="sample">
            <table width="770" border="0" cellspacing="1" cellpadding="0">
              <tr>
                <td height="21" bgcolor="#A24E12">&nbsp;<font color="#FFFFFF">添加友情连接</font></td>
              ...
              <tr>
                ...
                <td colspan="2" bgcolor="F1F0F1"><input name="w_url" type="text" id="w_url" size="50" maxlength="100">
