...
<head>
    ...
    <script src="../_inc/jquery-1.9.0.min.js"></script>
    <script src="../_inc/jquery.form.js"></script>
    <script>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr bgcolor="#E4E4E4">
        <td height="246" valign="top">
            <form id="userAddForm" name="form1" method="post" action="User_add_submit.php">
                <table width="740" border="0" cellspacing="1" cellpadding="0">
                    <tr>
                        ...
                        <td width="104" bgcolor="#FFFFFF">
                            <div align="center"><a href="User_List.php">返回前页</a></div>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td colspan="2" bgcolor="F1F0F1"><input name="MemaberName" type="text" id="MemaberName2"
                    ...
                    <tr>
                        ...
                        <td height="23" colspan="2" bgcolor="F1F0F1">
                            <input name="view" type="radio" value="open" checked>
                            开通
                            <input type="radio" name="view" value="close">
                            未开通
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td height="46" colspan="2" bgcolor="F1F0F1"><input type="submit" name="Submit" value="添加">
                            ...
                            <!--                  <input name="AddressID" type="hidden" value="-->
                            <?php //echo AddressID ?><!--">-->
                        </td>
                    </tr>
                    <tr>
