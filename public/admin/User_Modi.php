...
include("../_inc/checkoutTime.php");
    ...
    if ($msql->next_record()) {
        ...
        $checked1=$Opens=="open"?"checked":'';
        $checked2=$Opens=="open"?'':"checked";
    }
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr bgcolor="#E4E4E4">
      <td height="246" valign="top">
          <form name="form1" method="post" action="User_Modi_Submit.php">
            <table width="740" border="0" cellspacing="1" cellpadding="0">
              <tr>
                ...
                <td width="104" bgcolor="#FFFFFF"><div align="center"><a href="User_List.php">返回前页</a></div></td>
              </tr>
              <tr>
...
<div align="right"></div></td>
              ...
              <tr>
                ...
                <td colspan="2" bgcolor="F1F0F1"><input name="MemaberName" type="text" id="MemaberName" value="<?php echo $UserName ?>" size="20" maxlength="15"></td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td colspan="2" bgcolor="F1F0F1"><input name="ReMemberPass" type="password" id="ReMemberPass" size="40" maxlength="15">
                <font color="#990000">*</font></td>
              </tr>
              <tr>
                <td height="23" bgcolor="F1F0F1">&nbsp;开通状态：</td>
                <td height="23" colspan="2" bgcolor="F1F0F1">
                  <input name="view" type="radio" value="open" <?php echo $checked1 ?>>
                    开通
                  <input type="radio" name="view" value="close" <?php echo $checked2 ?>>
                    未开通</td>
              </tr>
              <tr>
                ...
                <td height="46" colspan="2" bgcolor="F1F0F1"> <input type="submit" name="Submit" value="修改">
                  <input type="button" name="Submit3" value="返回前页" onClick="location='User_List.php'">
