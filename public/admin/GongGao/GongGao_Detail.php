      ...
      <td height="246" valign="top" bgcolor="#E4E4E4">
          <form action="Visa_Add_Submit.php" method="post" name="sample" id="sample">
            <table width="700" border="0" cellspacing="1" cellpadding="0">
              <tr>
                <td height="21" bgcolor="#993300">&nbsp;<font color="#FFFFFF">������Ϣ</font></td>
                <td width="492" height="21" bgcolor="#FFFFFF">&nbsp;</td>
                <td width="103" bgcolor="#FFFFFF"><div align="center"><a href="GongGao_list.php?l_classid=<?php echo  $l_classid ?>">返回前页</a></div></td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td height="46" colspan="2" bgcolor="F1F0F1"><input type="button" name="Submit3" value="返回前页" onClick="location='GongGao_list.php?l_classid=<?php echo  $l_classid ?>'"></td>
              </tr>
              <tr>
