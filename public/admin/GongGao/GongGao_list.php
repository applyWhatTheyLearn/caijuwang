...
$msql->query("select * from z_affiche where 1=1 order by l_sort desc");
$l_classid='';
?>
        ...
        <tr bgcolor="#E4E4E4">
            <td height="230" valign="top">
                <table width="700" border="0" cellspacing="1" cellpadding="0">
                    <tr>
                        <td width="134" height="21" bgcolor="#993300">&nbsp;<font color="#FFFFFF">促销公告列表</font></td>
                        <form name="form1" method="post" action="GongGao_list.php">
                            <td width="471" bgcolor="#FFFFFF">&nbsp;</td>
                            <td width="91" bgcolor="#FFFFFF">
                                <div align="center"><a
                                        href="GongGao_add.php?l_classid=<?php echo  $l_classid ?>">添加促销公告</a></div>
                            </td>
                        </form>
                    </tr>
                    <tr>
                ...
                <?php if ($msql->num_rows() > 0) { ?>
                    <table width="700" border="0" cellpadding="0" cellspacing="1">
                        <tr>
                            <td height="15" colspan="10">
                                <div align="right">
                                    ...
                                    if (empty($l_classid)) {
                                        $subPages = new SubPages($page_size, $nums, $pageno, $sub_pages, "GongGao_list.php?pageno=", 2);
                                    } else {
                                        $subPages = new SubPages($page_size, $nums, $pageno, $sub_pages, "GongGao_list.php?l_classid=" . $l_classid . "&pageno=", 2);
                                    }
                                    ?>
                                </div>
                            </td>
                        ...
                        <tr>
                            ...
                            <td width="467" bgcolor="#999999">&nbsp;<font color="#FFFFFF" size="2">公告标题</font></td>
                            ...
                            if ($msql->next_record()) {
                                ...
                                <tr>
                                    ...
                                    <td height="18" valign="bottom" bgcolor="F1F0F1">&nbsp;<a
                                            href="GongGao_Detail.php?l_id=<?php echo $l_id ?>&l_classid=<?php echo  $l_classid ?>"><font
                                                color="#990000"><?php echo $l_title?></font></a> <font
                                            color="#666666"><?php echo $l_time ?></font></td>
                                    ...
                                    <td valign="bottom" bgcolor="F1F0F1">
                                        <div align="center">
                                            <div align="center"><a
                                                    href="GongGao_modi.php?l_id=<?php echo $l_id?>&l_classid=<?php echo  $l_classid ?>"><font
                                                        size="2">修改</font></a></div>
                                            <a href="GongGao_modi.php?l_id=<?php echo $l_id?>&l_classid=<?php echo  $l_classid ?>"><font
                                                    size="2"></font></a></div>
                                    </td>
                                    <td valign="bottom" bgcolor="F1F0F1">
                                        <div align="center"><a
                                                href="GongGao_del.php?l_id=<?php echo $l_id?>&l_classid=<?php echo  $l_classid ?>">
                                                删除</a></div>
                                    </td>
                                </tr>
                                <tr>
                ...
                <?php } else { ?>
                    <table width="700" height="69" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            <td bgcolor="#FFFFFF">
                                <div align="center"><a href="GongGao_add.php?l_classid=<?php echo  $l_classid ?>">暂无内容，请点击右上方添加文字添加相关内容</a>
                                </div>
                            </td>
                        </tr>
                    </table>
