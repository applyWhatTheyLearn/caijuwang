  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr bgcolor="#E4E4E4">
      <td height="246" valign="top">
          <form action="GongGao_modi_sub.php" method="post" name="sample" id="sample">
            <table width="700" border="0" cellspacing="1" cellpadding="0">
              <tr>
                <td height="21" bgcolor="#993300">&nbsp;<font color="#FFFFFF">修改帮助信息</font></td>
                <td width="529" height="21" bgcolor="#FFFFFF">&nbsp;</td>
                <td width="66" bgcolor="#FFFFFF"><div align="center"><a href="GongGao_list.php?l_classid=<?php echo  $l_classid ?>">返回前页</a></div></td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td height="23" colspan="2" bgcolor="F1F0F1"><font size="2"> &nbsp;显示
                  <input name="l_views" type="radio" value="显示" <?php echo $views1 ?>>
                  不显示
                  <input type="radio" name="l_views" value="不显示" <?php echo $views2 ?>>
                </font></td>
              </tr>
              <tr>
