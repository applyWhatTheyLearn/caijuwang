  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr bgcolor="#E4E4E4">
      <td height="246" valign="top" bgcolor="#E4E4E4">
          <form action="Comate_add_sub.php" method="post" name="sample" id="sample">
            <table width="770" border="0" cellspacing="1" cellpadding="0">
              <tr>
                <td height="21" bgcolor="#A24E12">&nbsp;<font color="#FFFFFF">添加合作伙伴</font></td>
                <td width="505" height="21" bgcolor="#FFFFFF">&nbsp;</td>
                <td width="107" bgcolor="#FFFFFF"><div align="center"><a href="Comate_list.php?class_id=<?php echo $class_id ?>">返回前页</a></div></td>
              </tr>
              <tr>
              ...
              <tr>
                <td valign="top" bgcolor="F1F0F1"><font size="2">&nbsp;伙伴名称:</font></td>
                <td height="22" colspan="2" bgcolor="F1F0F1"><input name="w_name" type="text" id="w_name" size="30" maxlength="30"></td>
              </tr>
              <tr>
                ...
                <td colspan="2" bgcolor="F1F0F1"><input name="w_url" type="text" id="w_url" size="50" maxlength="50">
                    例如：www.sohu.com 不用加 http://</td>
              </tr>
              <tr>
                <td height="21" valign="top" bgcolor="F1F0F1"><font size="2">&nbsp;排序：</font></td>
                <td height="21" colspan="2" valign="top" bgcolor="F1F0F1"><input name="w_sort" type="text" id="w_sort" size="20" maxlength="6"></td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <input type="button" name="Submit3" value="返回前页" onClick="location='Comate_list.php?class_id=<?php echo $class_id ?>'">
