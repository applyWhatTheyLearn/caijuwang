...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr bgcolor="#E4E4E4">
      <td height="246" valign="top" bgcolor="#E4E4E4">
          <form action="help_add_sub.php" method="post" name="sample" id="sample">
            <table width="700" border="0" cellspacing="1" cellpadding="0">
              <tr>
                <td height="21" bgcolor="#006699">&nbsp;<font color="#FFFFFF">�������</font></td>
                <td width="522" height="21" bgcolor="#FFFFFF">&nbsp;排序：���ࣺ[ <span class="STYLE3"><?php echo $l_classname ?></span> ]</td>
                <td width="73" bgcolor="#FFFFFF"><div align="center"><a href="help_list.php?l_classid=<?php echo  $l_classid ?>">返回前页</a></div></td>
              </tr>
              <tr>
              ...
              <tr>
                <td bgcolor="F1F0F1">&nbsp;排序：���<font size="2">��</font></td>
              ...
              <tr>
                ...
                <textarea name="l_detail" style="display:none" rows="1" cols="20"></textarea></td>
              </tr>
              <tr>
