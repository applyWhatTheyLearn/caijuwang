      ...
      <td height="246" valign="top" bgcolor="#E4E4E4">
          <form action="Visa_Add_Submit.php" method="post" name="sample" id="sample">
            <table width="700" border="0" cellspacing="1" cellpadding="0">
              <tr>
                <td height="21" bgcolor="#006699">&nbsp;<font color="#FFFFFF">������Ϣ</font></td>
              ...
              <tr>
                ...
                <td height="46" colspan="2" bgcolor="F1F0F1"><input type="button" name="Submit3" value="返回前页" onClick="location='help_list.php?l_classid=<?php echo  $l_classid ?>'"></td>
              </tr>
              <tr>
