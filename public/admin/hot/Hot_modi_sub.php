...
ChackError($l_title,"热门活动标题");
    $msql->query ("update z_hot set l_title='".$l_title."',l_detail='".$l_detail."',l_time='".date("Y-m-d H:i:s",time())."',l_sort='".$l_sort."',l_views='".$l_views."' where l_id=".$l_id);
?>
