...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr bgcolor="#E4E4E4">
      <td height="246" valign="top" bgcolor="#E4E4E4">
          <form action="Hot_add_sub.php" method="post" name="sample" id="sample">
            <table width="700" border="0" cellspacing="1" cellpadding="0">
              <tr>
                <td height="21" bgcolor="#993300">&nbsp;<font color="#FFFFFF">添加热门活动</font></td>
                <td width="506" height="21" bgcolor="#FFFFFF">&nbsp;</td>
                <td width="89" bgcolor="#FFFFFF"><div align="center"><a href="Hot_list.php?l_classid=<?php echo  $l_classid ?>">返回活动列表</a></div></td>
              </tr>
              <tr>
              ...
              <tr>
                <td bgcolor="F1F0F1">&nbsp;活动标题<font size="2">：</font></td>
