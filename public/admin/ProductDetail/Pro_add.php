...
$msql->query("select l_id,l_fid from z_class where l_id=".$l_classid);
if($msql->next_record()){
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr bgcolor="#E4E4E4">
      <td height="246" valign="top" bgcolor="#E4E4E4">
        <div align="center">
          <form action="Pro_Add_Submit.php" method="post" name="sample" id="sample"  onSubmit="return CheckForm(this);">
            <table width="740" border="0" align="left" cellpadding="0" cellspacing="1">
              <tr>
                <td height="21" bgcolor="#A24E12">&nbsp;<font color="#FFFFFF">添加新商品</font></td>
                <td width="537" height="21" bgcolor="#FFFFFF">&nbsp;</td>
                <td width="74" bgcolor="#FFFFFF"><div align="center"><a href="Pro_List.php?l_classid=<?php echo  $l_classid ?>">返回前页</a></div></td>
              </tr>
              <tr>
              ...
              <tr>
                <td height="22" bgcolor="F1F0F1"><font size="2">&nbsp;商品名称（中文）：</font></td>
              ...
              <tr>
                ...
                <td height="23" colspan="2" valign="top" bgcolor="F1F0F1">
                    <textarea name="l_basic" id="l_basic"></textarea>
              ...
              <tr>
                ...
                <td height="23" colspan="2" bgcolor="F1F0F1">
                    <textarea name="l_extend" id="l_extend"></textarea>
                    <script type="text/javascript">
              ...
              <tr>
                <td height="23" valign="top" bgcolor="F1F0F1"><font size="2" class="STYLE2">&nbsp;扩展信息（中文）：</font></td>
                <td height="23" colspan="2" bgcolor="F1F0F1">
                    <textarea name="l_extend_e" id="l_extend_e"></textarea>
                    <script type="text/javascript">
              ...
              <tr>
                ...
                <td height="46" colspan="2" bgcolor="F1F0F1"> <input type="submit" name="Submit" value="添加">
                  <input type="button" name="Submit3" value="返回前页" onClick="location='Pro_List.php?l_classid=<?php echo  $l_classid ?>'">
                  <input name="l_classid" type="hidden" value="<?php echo $l_classid?>">
                  <input name="l_fid" type="hidden" value="<?php echo $l_fid?>">                             </td>
              </tr>
              <tr>
