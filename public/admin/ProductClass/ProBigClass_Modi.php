    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr bgcolor="#E4E4E4">
            <td height="246" valign="top">
                <div align="center">
                    <form action="ProBigClass_Modi_Submit.php" method="post" name="sample" id="sample">
                        <table width="740" border="0" align="left" cellpadding="0" cellspacing="1">
                            <tr>
                                <td height="21" bgcolor="#A24E12">&nbsp;<font color="#FFFFFF">修改商品大类</font></td>
                                <td width="541" height="21" bgcolor="#FFFFFF">&nbsp;</td>
                                <td width="71" bgcolor="#FFFFFF">
                                    <div align="center"><a
                                            href="ProBigClass_List.php?pageno=<?php echo $pageno ?>">返回前页</a></div>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td bgcolor="F1F0F1"><font size="2">&nbsp;大类名称（中文）：</font></td>
                                <td colspan="2" bgcolor="F1F0F1"><input name="l_name" type="text" id="l_name"
                                                                        value="<?php echo $l_name ?>" size="70"
                                                                        maxlength="50"></td>
                            </tr>

                            <tr>
                                <td bgcolor="F1F0F1"><font size="2">&nbsp;大类名称（英文）：</font></td>
                                <td colspan="2" bgcolor="F1F0F1"><input name="l_name_e" type="text" id="l_name_e"
                                                                        value="<?php echo $l_name_e ?>" size="70"
                                                                        maxlength="50"></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td height="29" colspan="2" bgcolor="F1F0F1"><input name="l_sort" type="text"
                                                                                    id="l_sort"
                                                                                    value="<?php echo $l_sort ?>"
                                                                                    size="25" maxlength="6">
                                    *只能是小于6位数的数字（数字越大越靠前）
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td height="46" colspan="2" bgcolor="F1F0F1"><input type="submit" name="Submit"
                                                                                    value="修改">
                                    <input type="button" name="Submit3" value="返回前页"
                                           onClick="location='ProBigClass_List.php?pageno=<?php echo $pageno ?>'">
                                    <input name="l_id" type="hidden" value="<?php echo $l_id?>">
                                    <input name="pageno" type="hidden" value="<?php echo $pageno?>"></td>
                            </tr>
                            <tr>
