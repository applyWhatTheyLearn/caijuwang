  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr bgcolor="#E4E4E4">
      <td height="246" valign="top" bgcolor="#E4E4E4">
        <div align="center">
          <form action="ProSmallClass_add_Submit.php" method="post" name="sample" id="sample">
            <table width="740" border="0" align="left" cellpadding="0" cellspacing="1">
              <tr>
                <td height="21" bgcolor="#999966">&nbsp;<font color="#FFFFFF">添加商品小类</font></td>
                <td width="540" height="21" bgcolor="#FFFFFF">&nbsp;</td>
                <td width="68" bgcolor="#FFFFFF"><div align="center"><a href="ProSmallClass_List.php?l_classid=<?php echo  $l_classid ?>">返回前页</a></div></td>
              </tr>
              <tr>
              ...
              <tr>
                <td height="22" bgcolor="F1F0F1"><font size="2">&nbsp;小类名称（中文）：</font></td>
                <td colspan="2" bgcolor="F1F0F1"><input name="l_name" type="text" id="l_name" size="70" maxlength="50"></td>
              </tr>
              <tr>
                <td height="22" bgcolor="F1F0F1"><font size="2">&nbsp;小类名称（英文）：</font></td>
              ...
              <tr>
                ...
                <td height="46" colspan="2" bgcolor="F1F0F1"> <input type="submit" name="Submit" value="添加">
                  <input type="button" name="Submit3" value="返回前页" onClick="location='ProSmallClass_List.php?l_classid=<?php echo  $l_classid ?>'">
