...
$msql->query("select * from (".$NewOrderList.") as tb where l_orderstatu='新订单' order by l_ordertime desc");
        ...
        <tr bgcolor="#E4E4E4">
            <td height="230" valign="top">
                <table width="700" border="0" cellspacing="1" cellpadding="0">
                    <tr>
                        <td width="134" height="21" bgcolor="#993300">&nbsp;<font color="#FFFFFF">新订单列表</font></td>
                        <form name="form1" method="post" action="New_Order_list.php">
                            ...
                            <td height="15" colspan="12">
                                <div align="right">
                                    <div align="right">
                                        ...
                                        if (empty($l_classid)) {
                                            $subPages = new SubPages($page_size, $nums, $pageno, $sub_pages, "New_Order_list.php?pageno=", 2);
                                        } else {
                                            $subPages = new SubPages($page_size, $nums, $pageno, $sub_pages, "New_Order_list.php?l_classid=" . $l_classid . "&pageno=", 2);
                                        }
                            ...
                            if ($msql->next_record()) {
                                ...
                                <tr>
                                    ...
                                    <td height="18" valign="bottom" bgcolor="F1F0F1">
                                        <div align="center"><a
                                                href="New_Order_Change.php?l_id=<?php echo $l_id?>&pageno=<?php echo  $pageno ?>"
                                                title="订单确认"><?php echo $l_orderstatu?></a></div>
                                    </td>
                                    <td valign="bottom" bgcolor="F1F0F1">
                                        <div align="center"><a
                                                href="New_Order_del.php?l_id=<?php echo $l_id?>&pageno=<?php echo  $pageno ?>">删除</a>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
