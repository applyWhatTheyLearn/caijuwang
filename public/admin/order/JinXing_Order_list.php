...
$msql->query("select * from (".$NewOrderList.") as tb where l_orderstatu='进行中' order by l_ordertime desc");
?>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr bgcolor="#E4E4E4">
      ...
      <table width="700" border="0" cellspacing="1" cellpadding="0">
            <tr>
              <td width="134" height="21" bgcolor="#0033FF">&nbsp;<font color="#FFFFFF">进行中订单列表</font></td>
              <form name="form1" method="post" action="JinXing_Order_list.php">
...
<?php if($msql->num_rows()> 0){ ?>
          <table width="700" border="0" cellpadding="0" cellspacing="1">
            <tr>
              <td height="15" colspan="11"><div align="right">
                      <?php
                      //每页显示的条数
                      $page_size = 25;
                      //总条目数
                      ...
                      if (empty($l_classid)) {
                          $subPages = new SubPages($page_size, $nums, $pageno, $sub_pages, "JinXing_Order_list.php?pageno=", 2);
                      } else {
                          $subPages = new SubPages($page_size, $nums, $pageno, $sub_pages, "JinXing_Order_list.php?l_classid=" . $l_classid . "&pageno=", 2);
                      }
              ...
              <tr>
                  ...
                  <td width="122" bgcolor="#999999">&nbsp;<font color="#FFFFFF" size="2">移动电话</font></td>
                  <td width="94" bgcolor="#999999"><div align="center"><font color="#FFFFFF">订单状态</font></div></td>
              </tr>
            <?php
              $num = 1;
            ...
            <tr>
              ...
              <td height="18" valign="bottom" bgcolor="F1F0F1">&nbsp;<a href="New_Order_Detail.php?l_id=<?php echo  $l_id ?>&pageno=<?php echo  $pageno ?>" ><font color="#990000"><?php echo $l_orderform?></font></a></td>
              <td height="18" valign="bottom" bgcolor="F1F0F1">&nbsp;<a href="Member_Detail.php?meid=<?php echo  $l_userid ?>&pageno=<?php echo  $pageno ?>" ><?php echo $l_username?></a></td>
              <td height="18" valign="bottom" bgcolor="F1F0F1">&nbsp;<?php echo $l_price?></td>
              <td height="18" valign="bottom" bgcolor="F1F0F1">&nbsp;<?php echo $l_ordertime?></td>
      <td height="18" valign="bottom" bgcolor="F1F0F1">&nbsp;<?php echo $l_mobile?></td>
              <td height="18" valign="bottom" bgcolor="F1F0F1"><div align="center"><?php echo $l_orderstatu?>/<a href="#" title="订单确认" onClick="MM_openBrWindow('OrderChange.php?l_id=<?php echo  $l_id ?>','','scrollbars=yes,resizable=yes,width=420,height=600')">����</a></div></td>
</tr>
            <tr>
            ...
            <?php
              ...
              ?>		
            <tr>
              <td height="21" colspan="11" valign="top"> <?php
                  //每页显示的条数
                  $page_size = 25;
                  //总条目数
                  $nums = $msql->num_rows();
