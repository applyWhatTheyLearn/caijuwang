...
if ($msql->next_record()) {
    ...
    $l_views = trim($msql->f("Views"));
    $TID=''; //TODO 添加推荐人
    $View1 = $l_views == "已开通" ? "checked" : "";
    $View2 = $l_views == "未开通" ? "checked" : "";
}
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr bgcolor="#E4E4E4">
            <td height="246" valign="top" bgcolor="#E4E4E4">
                <div align="center">
                    <form action="Member_Modi_Submit.php" method="post" name="sample" id="sample">
                        <table width="740" border="0" align="left" cellpadding="0" cellspacing="1">
                            <tr>
                                ...
                                <td width="186" bgcolor="#FFFFFF">
                                    <div align="right"><a href="Member_List.php">返回前页</a></div>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td height="21" bordercolorlight="#999999" bordercolordark="#FFFFFF" bgcolor="F1F0F1">
                                    <font size="2">&nbsp;会员号：</font></td>
                                <td bgcolor="F1F0F1"><font size="2" color="#993300"><?php echo $Cnum ?></font></td>
                                <td bgcolor="F1F0F1">
                                    <div align="center">用户头像</div>
                                </td>
                            </tr>
                            <tr>
                                <td height="21" bordercolorlight="#999999" bordercolordark="#FFFFFF" bgcolor="F1F0F1">
                                    <font size="2">&nbsp;用户昵称：<font color="#FF0000">*</font></font></td>
                                <td bgcolor="F1F0F1"><input name="NickName" type="text" id="NickName" size="22"
                                                            maxlength="20" value="<?php echo $NickName ?>"></td>
              ...
              <tr>
                ...
                <td bgcolor="F1F0F1"><input name="UserName" type="text" id="UserName" size="22" maxlength="20" value="<?php echo $UserName ?>">
                  性别:
          ...
          <option value="女">女</option>
              ...
              <tr>
                <td height="21" bordercolorlight="#999999" bordercolordark="#FFFFFF" bgcolor="F1F0F1">&nbsp;用户密码：<font color="#FF0000">*</font></td>
                <td bgcolor="F1F0F1"><input name="UserPass" type="password" id="UserPass" size="22" maxlength="20">
                  交验用户密码：<font size="2"><font color="#FF0000">*</font></font>
              ...
              <tr>
                ...
                <td bgcolor="F1F0F1"><input name="UserLevel" type="text" id="UserLevel" size="22" maxlength="16"  value="<?php echo $UserLevel ?>"></td>
              </tr>
              <tr>
                <td height="18" bordercolorlight="#999999" bordercolordark="#FFFFFF" bgcolor="F1F0F1"><font size="2">&nbsp;联系地址:</font></td>
                <td bgcolor="F1F0F1"><input name="address" type="text" id="address" size="60" maxlength="50"  value="<?php echo $address ?>"></td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td height="23" colspan="2" bgcolor="F1F0F1"><font size="2"> <font size="2">&nbsp;</font>已开通
                  <input name="Views" type="radio" value="已开通" <?php echo $View1 ?>>
                        未开通
                  <input type="radio" name="Views" value="未开通" <?php echo $View2 ?>>
                </font></td>
              </tr>
              <tr>
                ...
                <td height="46" colspan="2" bgcolor="F1F0F1"><input type="submit" name="Submit" value="修改">
                    ...
                    <input name="Meid" type="hidden" value="<?php echo $Meid?>"></td>
                            </tr>
                            <tr>
