  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr bgcolor="#E4E4E4">
      <td height="246" valign="top">
          <form action="PingLun_modi_sub.php" method="post" name="sample" id="sample">
            <table width="700" border="0" cellspacing="1" cellpadding="0">
              <tr>
                <td height="21" bgcolor="#993300">&nbsp;<font color="#FFFFFF">修改<font color="#FFFFFF">评论信息</font></font></td>
                <td width="529" height="21" bgcolor="#FFFFFF">&nbsp;</td>
                <td width="66" bgcolor="#FFFFFF"><div align="center"><a href="PingLun_list.php?l_classid=<?php echo  $l_classid ?>">返回前页</a></div></td>
              </tr>
              <tr>
              ...
              <tr>
                <td height="21" valign="top" bgcolor="F1F0F1">&nbsp;评论标题：</td>
              ...
              <tr>
                <td height="23" valign="top" bgcolor="F1F0F1"><font size="2">&nbsp;评论内容：</font></td>
              ...
              <tr>
                ...
                <td height="46" colspan="2" bgcolor="F1F0F1"><input type="submit" name="Submit" value="修改">
                    <input type="button" name="Submit3" value="返回前页" onClick="location='PingLun_list.php?l_classid=<?php echo  $l_classid ?>'">
