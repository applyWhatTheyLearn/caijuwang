...
$msql->query("select * from z_return where 1=1 order by l_time desc");
$l_classid='';
?>
    ...
    <tr bgcolor="#E4E4E4">
      <td height="230" valign="top">
          <table width="700" border="0" cellspacing="1" cellpadding="0">
            <tr>
              <td width="134" height="21" bgcolor="#993300">&nbsp;<font color="#FFFFFF">意见反馈列表</font></td>
              <form name="form1" method="post" action="return_list.php">
...
<?php if($msql->num_rows()>0){ ?>
          <table width="700" border="0" cellpadding="0" cellspacing="1">
            <tr>
              <td height="15" colspan="8">
                  <div align="right">
                      ...
                      if (empty($l_classid)) {
                          $subPages = new SubPages($page_size, $nums, $pageno, $sub_pages, "return_list.php?pageno=", 2);
                      } else {
                          $subPages = new SubPages($page_size, $nums, $pageno, $sub_pages, "return_list.php?l_classid=" . $l_classid . "&pageno=", 2);
                      }
                      ?>
                  </div></td>
            </tr>
            ...
            <tr>
              ...
              <td height="18" valign="bottom" bgcolor="F1F0F1">&nbsp;<a href="return_Detail.php?l_id=<?php echo $l_id ?>&l_classid=<?php echo  $l_classid ?>" ><font color="#990000"><?php echo $l_title?></font></a></td>
              <td height="18" valign="bottom" bgcolor="F1F0F1">&nbsp;<?php echo $l_time ?></td>
              <td valign="bottom" bgcolor="F1F0F1"> <div align="center"><a href="return_del.php?l_id=<?php echo $l_id?>">
                  删除</a></div></td>
            </tr>
            <tr>
            ...
            <?php
                  ...
                  $num += 1;
					...
					?>
            <tr>
              <td height="21" colspan="8" valign="top">
                  <?php
                  //每页显示的条数
                  $page_size = 25;
                  //总条目数
          ...
          <table width="700" height="69" border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td bgcolor="#FFFFFF"><div align="center">
                <div align="center">暂无相关内容</div>
                <a href="help_add.php?l_classid=<?php echo  $l_classid ?>"></a></div></td>
            </tr>
          </table>
          <?php } ?>
      </td>
