...
<?php
	...
	search="select * from z_return  where l_id=".$l_id.""
	$msql->query(search)
	if($msql->next_record()){
          ...
          <form action="Visa_Add_Submit.php" method="post" name="sample" id="sample">
            <table width="700" border="0" cellspacing="1" cellpadding="0">
              <tr>
                ...
                <td width="103" bgcolor="#FFFFFF"><div align="center"><a href="return_list.php">返回前页</a></div></td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td height="22" colspan="2" bgcolor="F1F0F1"><font color="#990000"><?php echo $l_title ?></font> [ <?php echo $l_time ?> ]</td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td height="46" colspan="2" bgcolor="F1F0F1"><input type="button" name="Submit3" value="返回前页" onClick="location='return_list.php'"></td>
              </tr>
              <tr>
