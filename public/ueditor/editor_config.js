...
URL = "/nyhzs/public/ueditor/";
    ...
    window.UEDITOR_CONFIG = {
       ...
       //,imageFieldName:"upfile"                   //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        ...
        ,toolbars:[["source","undo","redo","insertorderedlist","link","insertimage","insertvideo","map","background","bold","italic","underline","forecolor","backcolor","justifyleft","justifycenter","indent","removeformat","formatmatch","fontfamily","fontsize","imagenone","imageleft","imageright","imagecenter","inserttable","deletetable","mergeright","mergedown","splittorows","splittocols","splittocells","mergecells","insertcol","insertrow","deletecol","deleterow","insertparagraphbeforetable"]]
