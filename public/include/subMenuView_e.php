		...
		<?php
			  ...
			  TitleName1=left(trim(Rs1("l_name_e")),9)
		...
		?>
				<table width=180 border=0 align=center cellpadding=1 cellspacing="1">
                 <tr>
                  ...
                  <td width=152 background="images/line-3.gif" bgcolor=#CAFFCA><?php echo( n ?>��<font color="#003366"><a href="../product_e/product_list.php?l_classid=<?php echo  $l_classid ?>" target="_parent"><?php echo( TitleName1 ?></a></font>                  </td>
                 </tr>
                </table>
				<?php
				  n=n+1
