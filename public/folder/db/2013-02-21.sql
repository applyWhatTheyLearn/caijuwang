DROP TABLE `Accredit`, `Accredit_t`, `admin`, `tb_member`, `w_ad_pic`, `w_copyright`, `w_db_bakinfo`, `z_affiche`, `z_car`, `z_carext`, `z_class`, `z_classpic`, `z_collection`, `z_comate`, `z_comments`, `z_contact`, `z_fittings`, `z_fittings_pic`, `z_helpclass`, `z_helpdetail`, `z_helpic`, `z_hot`, `z_link`, `z_order`, `z_product`, `z_productpic`, `z_return`, `z_smallclass`, `z_user`, `z_viewhistory` ;
...
insert into `z_comate`(`w_classid`,`w_name`,`w_url`,`w_pic`,`w_ext`,`w_sort`,`w_views`,`w_id`) values('','friend','www.sohu.com','','','22','显示','1');
...
insert into `z_user`(`shibie`,`Cnum`,`Email`,`NickName`,`UserName`,`ofrom`,`UserPass`,`age`,`Sex`,`UserLevel`,`Address`,`PostCode`,`Tel`,`mobile`,`RegTime`,`LastLoginTime`,`LoginNum`,`Photo`,`Detail`,`Msn`,`QQ`,`Tid`,`statu`,`Views`,`Meid`) values('wode','22359566','weiyongq@gmail.com','wei','yongqing','','c4ca4238a0b923820dcc509a6f75849b','','男','dad','sad','asd','ssasdf','','0000-00-00 00:00:00','0000-00-00 00:00:00','0','01.gif','<p> &nbsp; &nbsp;<strong>内容</strong> &nbsp; &nbsp; &nbsp;</p>','dsfaf','dffff','','','已开通','2');
