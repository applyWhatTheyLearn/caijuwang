  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr bgcolor="#E4E4E4"> 
      <td height="246" valign="top"> 
        <div align="center">
          <form action="ProBigClass_Modi_Submit.asp" method="post" name="sample" id="sample">
            <table width="740" border="0" align="left" cellpadding="0" cellspacing="1">
              <tr> 
                ...
                <td width="71" bgcolor="#FFFFFF"><div align="center"><a href="ProBigClass_List.asp?pageno=<%= pageno %>">����ǰҳ</a></div></td>
              </tr>
              <tr> 
              ...
              <tr>
                <td bgcolor="F1F0F1"><font size="2">&nbsp;������ƣ����ģ���</font></td>
              ...
              <tr> 
                ...
                <td height="46" colspan="2" bgcolor="F1F0F1"> <input type="submit" name="Submit" value="�޸�"> 
                  <input type="button" name="Submit3" value="����ǰҳ" onClick="location='ProBigClass_List.asp?pageno=<%= pageno %>'"> 
                  <input name="l_id" type="hidden" value="<%=l_id%>">            
                  <input name="pageno" type="hidden" value="<%=pageno%>">                                   </td>
              </tr>
              <tr> 
