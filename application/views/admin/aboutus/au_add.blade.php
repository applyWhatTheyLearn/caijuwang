...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr bgcolor="#E4E4E4"> 
      <td height="246" valign="top" bgcolor="#E4E4E4"> 
          <form action="au_add_sub.html" method="post" name="sample" id="sample">
            <table width="700" border="0" cellspacing="1" cellpadding="0">
              <tr> 
                <td height="21" bgcolor="#006699">&nbsp;<font color="#FFFFFF">添加内容</font></td>
                <td width="522" height="21" bgcolor="#FFFFFF">&nbsp;所属分类：[ <span class="STYLE3">分类标题名称</span> ]</td>
                <td width="73" bgcolor="#FFFFFF"><div align="center"><a href="au_list.html">返回前页</a></div></td>
              </tr>
              <tr> 
